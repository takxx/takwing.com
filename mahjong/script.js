...
const translations = {
  en: {
    ...
    noHint: "No matching moves available.",
    won: "You won!"
  },
  ...
  es: {
    ...
    noHint: "No hay movimientos coincidentes.",
    won: "¡Has ganado!"
  },
...
function showHint() {
  ...
  if (!hint) {
    showMessage(translate("noHint"), "wrong");
    render();
    return;
  }

  hintedTileIds.add(hint[0].id);
  hintedTileIds.add(hint[1].id);
